...
const navigation = [
  ["/chat", "New chat", MessageSquarePlus],
    ...
    <div className="app-frame">
      ...
      <aside className={cn("sidebar", open && "sidebar-open")}>
        ...
        <div className="status-pill">
          <span />
          <p>
            <strong>EVA is ready</strong>
            <small>English · Kinyarwanda</small>
          </p>
        </div>
          ...
          {navigation.map(([href, label, Icon]) => (
            <Link
              ...
              className={cn(
                ...
                (pathname === href ||
                  (href === "/study" &&
                    ["/documents", "/voice"].includes(pathname))) &&
                  "active",
              )}
            >
              <Icon size={18} />
        ...
        <div className="sidebar-foot">
          ...
          <div className="user-meta">
            ...
            <small>{user.profile_type.replaceAll("_", " ")}</small>
          </div>
          <Button
            onClick={logout}
            variant="ghost"
